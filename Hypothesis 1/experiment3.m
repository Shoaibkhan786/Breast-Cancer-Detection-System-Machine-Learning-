...
%data for training 
trainingData2=data(1:21,2:10); 
trainingData4=data(460:649,2:10);
trainingData=[trainingData2;trainingData4];

%targets values of training data
targetValue2=data(1:21,11); 
targetValue4=data(460:649,11);
...
%testing data
testData2=data(22:459,2:10);
testData4=data(650:699,2:10);
...
actualOutputs2=data(22:459,11);
actualOutputs4=data(650:699,11);
