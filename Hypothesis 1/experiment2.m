...
%data for training 
trainingData2=data(1:189,2:10); 
trainingData4=data(460:481,2:10);
trainingData=[trainingData2;trainingData4];

%targets values of training data
targetValue2=data(1:189,11); 
targetValue4=data(460:481,11);
...
%testing data
testData2=data(190:459,2:10);
testData4=data(481:699,2:10);
...
actualOutputs2=data(190:459,11);
actualOutputs4=data(481:699,11);
